...
MODELS : ModelSet =\
{
	'ddcolor':
	{
		...
		'path': resolve_relative_path('../../models/models/ddcolor.onnx'),
		'size': (512, 512)
	},
	'ddcolor_artistic':
	{
		...
		'path': resolve_relative_path('../../models/models/ddcolor_artistic.onnx'),
		'size': (512, 512)
	},
	'deoldify':
	{
		...
		'path': resolve_relative_path('../../models/models/deoldify.onnx'),
		'size': (256, 256)
	},
	'deoldify_artistic':
	{
		...
		'path': resolve_relative_path('../../models/models/deoldify_artistic.onnx'),
		'size': (256, 256)
	},
	'deoldify_stable':
	{
		...
		'path': resolve_relative_path('../../models/models/deoldify_stable.onnx'),
		'size': (256, 256)
	}
}
